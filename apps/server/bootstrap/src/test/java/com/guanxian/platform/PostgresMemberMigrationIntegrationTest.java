...
class PostgresMemberMigrationIntegrationTest {
    ...
    void baselinesExistingSchemaMigratesColumnsAndPreservesMemberData() throws Exception {
        ...
        // Baseline 0 + V1..V23 + V25..V27. The unreleased personal-model V24 is not part of this release.
        org.junit.jupiter.api.Assertions.assertEquals(27, migrationCount);
