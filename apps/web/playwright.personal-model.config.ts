...
export default defineConfig({
  testDir: './tests/ui',
  testMatch: ['personal-model.spec.ts', 'assistant-output.spec.ts', 'assistant-business-results.spec.ts', 'assistant-followup.spec.ts', 'assistant-fit-check.spec.ts'],
  outputDir: '../../test-results/personal-model-ui',
  workers: 1,
  timeout: 30000,
  use: { ...devices['Desktop Chrome'], baseURL: 'http://127.0.0.1:18186', locale: 'zh-CN' },
  webServer: {
