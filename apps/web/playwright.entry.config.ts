...
export default defineConfig({
  testDir: './tests/ui',
  testMatch: ['entry-routing.spec.ts', 'enterprise-onboarding.spec.ts', 'enterprise-self-service.spec.ts', 'enterprise-accounts.spec.ts', 'session-renewal.spec.ts', 'source-directory.spec.ts'],
