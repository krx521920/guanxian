...
import EnterpriseAccountDialog from '../components/EnterpriseAccountDialog.vue'
...
const accountTarget = ref<string | null>(null)
...
<template>
  <div>
    <EnterpriseAccountDialog v-if="accountTarget" :key="accountTarget" :enterprise-id="accountTarget" @close="accountTarget = null" />
...
<style scoped>
.member-table td[data-label="操作"] button { white-space: nowrap; }
</style>
