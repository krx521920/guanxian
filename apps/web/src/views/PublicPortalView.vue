    ...
    <main id="public-main">
      <section class="public-hero">
        <div class="public-container">
          ...
          <p>了解管线智联，寻找企业、政策与合作信息的入口。企业管理和协会运营请进入各自的授权工作空间。</p>
      ...
      <div class="public-container public-content">
        ...
        <section id="public-guide" aria-labelledby="guide-title">
          ...
          <div class="public-guide-grid">
            <article><span class="public-step">01 / 游客</span><h3>了解平台</h3><p>无需账号即可浏览本页说明。后续企业和政策的公开内容，将在审核与发布后逐步开放。</p><a href="#public-directory">查看开放进度 →</a></article>
