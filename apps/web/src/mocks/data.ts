...
export const notifications: NotificationMessage[] = [
  { id: 'N001', userId: 'demo-user', associationId: null, notificationType: 'POLICY', title: '北京市地下管线信息管理办法更新', body: '已识别 4 类会员企业可能受到影响。', resourceType: 'POLICY_DOCUMENT', resourceId: 'P002', status: 'DELIVERED', readAt: null, createdAt: new Date(Date.now() - 18 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 18 * 60_000).toISOString() },
  { id: 'N002', userId: 'demo-user', associationId: null, notificationType: 'MATCH', title: '新增 6 组生态匹配建议', body: '涉及燃气安全、管线探测和非开挖修复场景。', resourceType: 'ECOSYSTEM_MATCH', resourceId: 'M001', status: 'DELIVERED', readAt: null, createdAt: new Date(Date.now() - 65 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 65 * 60_000).toISOString() },
  { id: 'N003', userId: 'demo-user', associationId: null, notificationType: 'COLLABORATION', title: '联合评估事项状态已更新', body: '高压燃气管道零泄漏阀门联合评估进入新阶段。', resourceType: 'COLLABORATION', resourceId: 'C001', status: 'READ', readAt: new Date(Date.now() - 20 * 60_000).toISOString(), createdAt: new Date(Date.now() - 24 * 60 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 24 * 60 * 60_000).toISOString() },
  { id: 'N004', userId: 'demo-user', associationId: null, notificationType: 'MEMBER', title: '会员企业资料待审核', body: '中勘地下空间技术研究院已提交最新认证资料。', resourceType: 'MEMBER_ENTERPRISE', resourceId: 'E004', status: 'READ', readAt: new Date(Date.now() - 3 * 60 * 60_000).toISOString(), createdAt: new Date(Date.now() - 3 * 60 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 3 * 60 * 60_000).toISOString() },
  { id: 'N005', userId: 'demo-user', associationId: null, notificationType: 'POLICY', title: '政策影响提醒已归档', body: '城镇燃气管网泄漏监测技术导则影响分析已完成。', resourceType: 'POLICY_DOCUMENT', resourceId: 'P003', status: 'ARCHIVED', readAt: new Date(Date.now() - 2 * 24 * 60 * 60_000).toISOString(), createdAt: new Date(Date.now() - 2 * 24 * 60 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 2 * 24 * 60 * 60_000).toISOString() },
  { id: 'N006', userId: 'demo-user', associationId: null, notificationType: 'COLLABORATION', title: '协作事项已归档', body: '非开挖修复评价标准案例征集已完成并归档。', resourceType: 'COLLABORATION', resourceId: 'C004', status: 'ARCHIVED', readAt: new Date(Date.now() - 4 * 24 * 60 * 60_000).toISOString(), createdAt: new Date(Date.now() - 4 * 24 * 60 * 60_000).toISOString(), deliveredAt: new Date(Date.now() - 4 * 24 * 60 * 60_000).toISOString() },
]
