  ...
  routes: [
    ...
    { path: '/auth/callback', name: 'auth-callback', component: () => import('../views/OidcCallbackView.vue'), meta: { title: '身份验证' } },
    {
      ...
      children: [
        ...
        { path: '/enterprise/catalog', component: () => import('../views/EcosystemCatalogView.vue'), meta: { title: '我的供需', roles: protectedRouteRoles['/enterprise/catalog'] } },
        { path: '/enterprise/cooperation', component: () => import('../views/EnterpriseCooperationView.vue'), meta: { title: '我的合作', roles: protectedRouteRoles['/enterprise/cooperation'] } },
        { path: '/enterprise/team', component: () => import('../views/EnterpriseTeamView.vue'), meta: { title: '企业团队', roles: protectedRouteRoles['/enterprise/team'] } },
